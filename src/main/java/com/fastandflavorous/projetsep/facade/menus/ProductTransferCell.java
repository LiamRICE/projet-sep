...
public class ProductTransferCell extends ListCell<Product> {
    HBox hbox = new HBox();
    ...
    public ProductTransferCell(boolean available) {
        super();
        if(available){
            button = new Button("=>");
        }else{
        ...
        button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                MenuController.shiftProductInTempList(productItem);
            }
        });
    }
